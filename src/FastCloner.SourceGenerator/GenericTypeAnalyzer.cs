...
namespace FastCloner.SourceGenerator
{
    internal static class GenericTypeAnalyzer
    {
            ...
            TargetFramework targetFramework)
        {
            ...
            var isClonableInterface = TypeAnalyzer.HasClonableInterface(typeArg);
            ...
            void CollectImplicitRecursively(ITypeSymbol t)
            {
                ...
                if (ImplicitTypeAnalyzer.TryAnalyze(t, compilation, nullability, targetFramework, implicitCache, processingStack, out var implicitModel))
                {
            ...
            if (isSafe || isClonable || isClonableInterface || collectionModel != null || implicitTypes.Count > 0)
            {
                ...
                return new GenericUsage(targetSymbol.OriginalDefinition.ToDisplayString(SymbolDisplayFormat.FullyQualifiedFormat),
                                        typeArgFQN,
                                        extensionClassFQN,
                                        collectionModel,
